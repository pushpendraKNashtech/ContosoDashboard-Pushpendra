...
- **Framework**: ASP.NET Core target currently configured as .NET 10.0 in `ContosoDashboard.csproj`
- **UI**: Blazor Server
- **Database**: SQL Server LocalDB with Entity Framework Core 8 package references
